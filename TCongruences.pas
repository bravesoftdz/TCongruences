...
type
 TCongruence = class(TObject)
  private
   ...
   procedure sort(a: TSolutions);
  public
   constructor Create(a, b, n: integer);
   function getSolution: TSolutions; virtual;
...
function TCongruence.gcdExtended(p, q: integer): TSolutions;
...
procedure TCongruence.sort(a: TSolutions);
var
  i, j, item: Integer;
begin
...
function TCongruence.getSolution: TSolutions;
var m, i: integer;
    tmp: TSolutions;
begin
